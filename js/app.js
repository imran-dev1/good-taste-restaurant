...
const displayMealDetails = (meal) => {
  ...
  modalContent.innerHTML = `
      <div class="col-md-4" style="background-image:url('${meal.strMealThumb}');background-repeat: no-repeat; background-position: center center; background-size: cover;">
      ...
      <div class="col-md-8">
          ...
          <div class="card-body text-start">
              ...
              <p class="ingredients">Ingredients: <span>${meal.strIngredient1}</span><span>${meal.strIngredient2}</span><span>${meal.strIngredient3}</span><span>${meal.strIngredient4}</span><span>${meal.strIngredient5}</span><span>${meal.strIngredient6}</span></p>
          </div>
      </div>
  `;
